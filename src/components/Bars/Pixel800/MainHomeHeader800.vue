<template>
  <div>
    <v-toolbar elevation="0" class="MainHomeHeader800Style">
      <v-app-bar-title>
...
.MainHomeHeader800ButtonLogoStyle {
  font-size: 15px;
  color: #000000;
  cursor: pointer;
}
.MainHomeHeader800ButtonLogoStyle:hover {
