<template>
  <div>
    <v-app-bar elevation="0" class="PagesHeader800Style">
      ...
      <v-btn icon="mdi-account-outline" class="PagesHeader800ButtonLogoStyle" :ripple="false"/>
      <v-btn icon="mdi-dots-vertical" class="PagesHeader800ButtonLogoStyle" :ripple="false"/>
    </v-app-bar>
  </div>
</template>
...
.PagesHeader800ButtonLogoStyle {
  font-size: 15px;
  color: #000000;
  cursor: pointer;
}
.PagesHeader800ButtonLogoStyle:hover {
