<template>
  <div>
    <v-app-bar elevation="0" class="MainHomeHeader500Style">
      <v-app-bar-title>
        <v-img :style="TriPlandLogoStyle" :src="TriPlandLogo" alt="TriPland 로고"/>
      </v-app-bar-title>
      <v-btn icon="mdi-account-outline" class="MainHomeHeader500ButtonLogoStyle" :ripple="false"/>
    </v-app-bar>
  </div>
</template>
...
.MainHomeHeader500ButtonLogoStyle {
  font-size: 12px;
  color: #000000;
  cursor: pointer;
}
.MainHomeHeader500ButtonLogoStyle:hover {
